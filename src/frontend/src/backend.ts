...
import type { CallState as _CallState, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async acceptCall(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async acceptConnectionRequest(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async declineCall(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async endCall(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getCallState(): Promise<CallState | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallState();
    ...
    async getPendingRequests(): Promise<Array<ConnectionRequest>> {
        if (this.processError) {
            try {
    ...
    async getUserByUsername(arg0: Username): Promise<UserProfile | null> {
        if (this.processError) {
            try {
    ...
    async onboard(arg0: string, arg1: string, arg2: string): Promise<UserProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.onboard(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectConnectionRequest(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CallState]): CallState | null {
